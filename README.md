...
**[DECODE A MORSE CODE]** is a tool for decrypting messages in Morse code using Ruby to help yourself by automating this process.
...
- **[Add morse.rb]**
- **[Install linters]**
- **[Add methods to decode in morse.rb]**
